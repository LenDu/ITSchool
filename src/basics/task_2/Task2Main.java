...
//        }
        ...
        System.out.println("6. The 1st number with digits in ascending order: " + task26.findNumberWithDigitsInAscendingOrder(input));

        Task27 task27 = new Task27();
        System.out.println("7. The 1st number with unique digits: " + task27.getNumberWithUniqueDigits(input));
